...
/// The decimal precision of the ZE token.
/// There are 100 billion indivisible units per ZEE (called "grains").
pub const TOKEN_DECIMALS: u8 = 11;

/// The decimal precision of the ZEE v1 token.
pub const TOKEN_DECIMALS_V1: u8 = 9;

/// One ZEE token, denominated in indivisible units.
pub const ONE_ZE: u64 = 10u64.pow(TOKEN_DECIMALS as u32);
...
pub const MAX_SUPPLY: u64 = ONE_ZE * 5_000_000;

/// The target quantity of ZE to be mined per epoch.
pub const TARGET_EPOCH_REWARDS: u64 = ONE_ZE * EPOCH_MINUTES as u64;

/// The maximum quantity of ZE that can be mined per epoch.
/// Inflation target ≈ 1 ZE / min
pub const MAX_EPOCH_REWARDS: u64 = TARGET_EPOCH_REWARDS * BUS_COUNT as u64;

/// The quantity of ZE each bus is allowed to issue per epoch.
...
pub const METADATA_NAME: &str = "ZE";

/// The ticker symbol for token metadata.
pub const METADATA_SYMBOL: &str = "ZE";

/// The uri for token metdata.
pub const METADATA_URI: &str = "https://zeminers.vip/metadata-v2.json";
...
pub const MINT_V1_ADDRESS: Pubkey = pubkey!("zeoN2tQbHXVaZsr3pf66A48miqcBXCDJozganhEJgz");
