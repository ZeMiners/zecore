...
/// Initialize sets up the ZE program to begin mining.
pub fn process_initialize(accounts: &[AccountInfo<'_>], _data: &[u8]) -> ProgramResult {
    ...
    bus_0_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[0]], &ze_api::ID)?;
    bus_1_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[1]], &ze_api::ID)?;
    bus_2_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[2]], &ze_api::ID)?;
    bus_3_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[3]], &ze_api::ID)?;
    bus_4_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[4]], &ze_api::ID)?;
    bus_5_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[5]], &ze_api::ID)?;
    bus_6_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[6]], &ze_api::ID)?;
    bus_7_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[BUS, &[7]], &ze_api::ID)?;
    config_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[CONFIG], &ze_api::ID)?;
    ...
    mint_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[MINT, MINT_NOISE.as_slice()], &ze_api::ID)?;
    treasury_info
        .is_empty()?
        .is_writable()?
        .has_seeds(&[TREASURY], &ze_api::ID)?;
    ...
    for i in 0..BUS_COUNT {
        ...
        let bus = bus_infos[i].as_account_mut::<Bus>(&ze_api::ID)?;
        bus.id = i as u64;
        bus.rewards = 0;
    ...
    let config = config_info.as_account_mut::<Config>(&ze_api::ID)?;
